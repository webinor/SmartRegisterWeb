        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h2 class="white-color" style="font-size: 30px;">Effacer une compétence</h2>
                    <ul class="breadcrumb">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div>
                    ...
                    <div>Cette section a pour but de vous apprendre à effacer des compétences </div>
                    <br>
                    <ul>
                        <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/deleteSkill1.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/deleteSkill2.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <li> 
                            ...
                            <span class="tuto-text">3- appuyez sur la compétence à Effacer pour dérouler le menu.</span>
                            
                            <div>
                                <img src="<?= $hote ?>images/tuto/deleteSkill3.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/deleteSkill4.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/deleteSkill5.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
