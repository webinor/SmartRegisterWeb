        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h2 class="white-color" style="font-size: 30px;">Gestion des fichiers PDF</h2>
                    <ul class="breadcrumb">
        ...
        <div class="container">
            ...
            <div class="row tuto-text">
                ...
                <div>
                         ...
                         <li>
                                 ...
                                 <img src="<?= $hote ?>images/tuto/homePdf.jpg" <?= $dimension ?> class="img-shadow" >
                                   ...
                                   <ol>
                                       ...
                                       vous devez cocher dans un premier temps au plus 6 rubriques ( disciplines ) car au delà, toutes les rubriques ne ressortiront pas sur le fichier PDF. Il est donc conseillé de creer deux fichier PDF : un premier pour les 6 premières rubriques et un second pour le reste.
                                       <a class="link_dotted" href="<?php echo $hote.'help/updated/pdfCreate.php?phnNum='.(isset($_GET['phnNum']) ? $_GET['phnNum'] : '0').'&lang='.(isset($_GET['lang']) ? $_GET['lang'] : 'fr') ?>" target="blank" >En savoir plus</a> </li>
                                    </ol>
                    ...
                    <h3>4- Exemples de fichiers PDF</h3>
