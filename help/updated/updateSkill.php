        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h2 class="white-color" style="font-size: 30px;">Comment modifier une competence ?</h2>
                    <ul class="breadcrumb">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div>
                   ...
                   <div>Cette section a pour but de vous apprendre à modifier une compétence  </div>
                    <br>
                    <ul>
                        <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSkill1.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <br>
                          ...
                          <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSkill2.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <br>
                          ...
                          <li> 
                            ...
                            <span class="tuto-text">3- Appuyez sur la compétence à modifier.</span>
                            
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSkill3.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <br>
                          ...
                          <li> 
                              ...
                              <span>Lorsque le menu se deroule :</span>
                            
                              <ul>
                                  <li>4-a Saisissez le nouveau nom de la competence ( Par exemple Tech info com )</li>
                                  <li>4-b Saisissez la nouvelle note maximale à l'ecrit ( Par exemple 10 )</li>
                                  <li>4-c Saisissez la nouvelle note maximale à l'oral ( Par exemple 5 )</li>
                                  <li>4-d Saisissez la nouvelle note maximale en Pratique ( Par exemple 20 )</li>
                                  <li>4-e Saisissez la nouvelle note maximale en Savoir-etre ( Par exemple 5 )</li>
                                  <li>4-f Appuyez sur "Modifier"</li>
                              </ul>
                            
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSkill4.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                     ...
                     <ul>
                         <li>
                             <a href="addSkill.php">Comment ajouter une compétence ?</a>  
                         </li>
