        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 text-center">
                    <h2 class="white-color" style="font-size: 30px;">Comment modifier une discipline ?</h2>
                    <ul class="breadcrumb">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div>
                   ...
                   <div>Cette section a pour but de vous apprendre à modifier une discipline</div>
                    <br>
                    <ul>
                        <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSubject1.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <br>
                          ...
                          <li> 
                            ...
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSubject2.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <br>
                          ...
                          <li> 
                            ...
                            <span class="tuto-text">3- Appuyez sur la discipline à modifier.</span>
                            
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSubject3.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
                        ...
                        <br>
                          ...
                          <li> 
                              ...
                              <span>Lorsque le menu se déroule :</span>
                            
                              <ul>
                                  <li>4-a Saisissez le nouveau nom de la discipline</li>
                                  <li>4-b Saisissez la nouvelle note maximale</li>
                                  <li>4-c Appuyez sur "Modifier"</li>
                              </ul>
                            
                            <div>
                                <img src="<?= $hote ?>images/tuto/updateSubject4.jpg" <?= $dimension ?> class="img-shadow" >
                            </div>
