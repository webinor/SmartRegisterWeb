...
<div class="modal fade" id="myModal_full" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" style="margin-top: 120px;" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h5 class="modal-title" id="myModalLabel">Vous recevrez votre code d'activation via sms au numéro que vous indiquerez plus bas</h5>
      </div>
  ...
  <div class="form-group">
    ...
    <span id="unknow_user" class="help-block hidden "><?="Prenom incorrect"?></span>
              ...
              <div class="form-group">
    <label for="exampleInputEmail1">Votre numero de telephone ( MTN Mobile money )</label>
    <input type="number" class="form-control phone must_be_validated" placeholder="Votre numero de telephone" value="">
...
<option value="Professionnel:1500:3">Code valide 3 Mois : 1499 FCFA</option>
<option value="Professionnel:2500:10">Code valide 10 Mois : 2499 FCFA</option>
</select>
...
<div class="modal fade" id="myModal_premium" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  ...
  <div class="form-group">
    ...
    <select name="momoamount" class="form-control momo-PrepaidAccountAmount must_be_validated" autocomplete="off" autocorrect="off">
<option value="">Selectionner un des codes suivants</option>
<option value="Premium:600:1">Code valide 1 Mois : 599 FCFA</option>
<option value="Premium:1500:3">Code valide 3 Mois : 1499 FCFA</option>
<option value="Premium:2000:10">Code valide 10 Mois : 1999 FCFA</option>
</select>
    <span id="unknow_user" class="help-block hidden "><?= "Selectionnez un fotfait" ?></span>
  </div>
            <input type="hidden" name="amount" class="final_amount">
